...
@section('title', 'Edit Pemeriksaan Badan')

@section('content')
<div class="container-lg">
    <form method="POST" action="{{ route('pemeriksaan-badan.update', $pemeriksaanBadan->id) }}" id="editPemeriksaanForm">
        @csrf
        @method('PUT')
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-warning text-dark">
                <h4 class="card-title mb-0 d-flex align-items-center">
                    ...
                    <span><strong>Edit Pemeriksaan Badan</strong></span>
                </h4>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control @error('tgl_ba_riksa') is-invalid @enderror" id="tgl_ba_riksa" name="tgl_ba_riksa" value="{{ old('tgl_ba_riksa', $pemeriksaanBadan->tgl_ba_riksa->format('Y-m-d')) }}" required>
                                            @error('tgl_ba_riksa')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control @error('no_surat_perintah') is-invalid @enderror" list="datalistOptions" id="no_surat_perintah" name="no_surat_perintah" placeholder="Ketik untuk mencari..." value="{{ old('no_surat_perintah', $pemeriksaanBadan->no_surat_perintah) }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="cil-calendar"></i></span>
                                            <input type="date" class="form-control @error('tgl_surat_perintah') is-invalid @enderror" id="tgl_surat_perintah" name="tgl_surat_perintah" value="{{ old('tgl_surat_perintah', $pemeriksaanBadan->tgl_surat_perintah ? $pemeriksaanBadan->tgl_surat_perintah->format('Y-m-d') : '') }}" readonly>
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ old('nama', $pemeriksaanBadan->nama) }}">
                                            @error('nama')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('no_identitas') is-invalid @enderror" id="no_identitas" name="no_identitas" value="{{ old('no_identitas', $pemeriksaanBadan->no_identitas) }}">
                                            @error('no_identitas')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir', $pemeriksaanBadan->tempat_lahir) }}">
                                            @error('tempat_lahir')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="cil-calendar"></i></span>
                                            <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="tanggal_lahir" name="tanggal_lahir" value="{{ old('tanggal_lahir', $pemeriksaanBadan->tanggal_lahir->format('Y-m-d')) }}">
                                            @error('tanggal_lahir')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control @error('alamat_pada_identitas') is-invalid @enderror" id="alamat_pada_identitas" name="alamat_pada_identitas" rows="2">{{ old('alamat_pada_identitas', $pemeriksaanBadan->alamat_pada_identitas) }}</textarea>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control @error('alamat_tinggal') is-invalid @enderror" id="alamat_tinggal" name="alamat_tinggal" rows="2">{{ old('alamat_tinggal', $pemeriksaanBadan->alamat_tinggal) }}</textarea>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('datang_dari') is-invalid @enderror" id="datang_dari" name="datang_dari" value="{{ old('datang_dari', $pemeriksaanBadan->datang_dari) }}">
                                            @error('datang_dari')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="cil-location-pin"></i></span>
                                            <input type="text" class="form-control @error('tujuan_ke') is-invalid @enderror" id="tujuan_ke" name="tujuan_ke" value="{{ old('tujuan_ke', $pemeriksaanBadan->tujuan_ke) }}">
                                            @error('tujuan_ke')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('lokasi_pemeriksaan') is-invalid @enderror" id="lokasi_pemeriksaan" name="lokasi_pemeriksaan" value="{{ old('lokasi_pemeriksaan', $pemeriksaanBadan->lokasi_pemeriksaan) }}">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <textarea class="form-control @error('hasil_pemeriksaan') is-invalid @enderror" id="hasil_pemeriksaan" name="hasil_pemeriksaan" rows="3">{{ old('hasil_pemeriksaan', $pemeriksaanBadan->hasil_pemeriksaan) }}</textarea>
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('rekan_perjalanan') is-invalid @enderror" id="rekan_perjalanan" name="rekan_perjalanan" value="{{ old('rekan_perjalanan', $pemeriksaanBadan->rekan_perjalanan) }}">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('nama_sarkut') is-invalid @enderror" id="nama_sarkut" name="nama_sarkut" value="{{ old('nama_sarkut', $pemeriksaanBadan->nama_sarkut) }}">
                                            @error('nama_sarkut')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control @error('no_register') is-invalid @enderror" id="no_register" name="no_register" value="{{ old('no_register', $pemeriksaanBadan->no_register) }}">
                                            @error('no_register')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                           <span class="input-group-text"><i class="cil-file"></i></span>
                                           <input type="text" class="form-control @error('jenis_dokumen_barang') is-invalid @enderror" name="jenis_dokumen_barang" placeholder="Jenis" value="{{ old('jenis_dokumen_barang', $pemeriksaanBadan->jenis_dokumen_barang) }}">
                                           <input type="text" class="form-control @error('nomor_dokumen_barang') is-invalid @enderror" name="nomor_dokumen_barang" placeholder="Nomor" value="{{ old('nomor_dokumen_barang', $pemeriksaanBadan->nomor_dokumen_barang) }}">
                                           <input type="date" class="form-control @error('tgl_dokumen_barang') is-invalid @enderror" name="tgl_dokumen_barang" placeholder="Tanggal" value="{{ old('tgl_dokumen_barang', $pemeriksaanBadan->tgl_dokumen_barang ? $pemeriksaanBadan->tgl_dokumen_barang->format('Y-m-d') : '') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
