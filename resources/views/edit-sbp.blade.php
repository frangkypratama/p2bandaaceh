...
<div class="container-lg">
    <form method="POST" action="{{ route('sbp.update', $sbp->id) }}" id="editSbpForm">
        @csrf
        @method('PUT')
            ...
            <div class="card-body p-4">
                ...
                <div class="row g-4">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="nomor_sbp" type="number" class="form-control @error('nomor_sbp_final') is-invalid @enderror" name="nomor_sbp" value="{{ old('nomor_sbp', $sbp->nomor_sbp_int ?? '') }}" placeholder="Masukkan hanya angka" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input id="tanggal_sbp" type="date" class="form-control" name="tanggal_sbp" value="{{ old('tanggal_sbp', (isset($sbp) && $sbp->tanggal_sbp) ? $sbp->tanggal_sbp->format('Y-m-d') : '') }}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" list="datalistOptions" id="nomor_surat_perintah" name="nomor_surat_perintah" placeholder="Ketik untuk mencari..." value="{{ old('nomor_surat_perintah', $sbp->nomor_surat_perintah ?? 'PRIN-') }}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <span class="input-group-text"><i class="cil-calendar"></i></span>
                                            <input id="tanggal_surat_perintah" type="date" class="form-control" name="tanggal_surat_perintah" value="{{ old('tanggal_surat_perintah', (isset($sbp) && $sbp->tanggal_surat_perintah) ? $sbp->tanggal_surat_perintah->format('Y-m-d') : '') }}" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card h-100 border-light shadow-sm">
                            <div class="card-header bg-light">
                                <h5 class="card-title mb-0 d-flex align-items-center"><i class="cil-user me-2"></i>Data Identitas Pelaku</h5>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
                                     <div class="col-12">
                    ...
                    {{-- Informasi Barang Bukti --}}
                     <div class="col-md-12">
                        <div class="card h-100 border-light shadow-sm">
                            <div class="card-header bg-light">
                                <h5 class="card-title mb-0 d-flex align-items-center"><i class="cil-briefcase me-2"></i>Informasi Barang Bukti</h5>
                            </div>
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="border rounded p-3 bg-white h-100">
                                            <label class="form-label fw-bold">BAST (Berita Acara Serah Terima)</label>
                                    ...
                                    <div class="col-md-6">
                                         <div class="border rounded p-3 bg-white h-100">
                                            <label class="form-label fw-bold">BA Musnah (Berita Acara Pemusnahan)</label>
        ...
        <input type="hidden" name="flag_ba_musnah" id="hidden_flag_ba_musnah" value="{{ old('flag_ba_musnah', $sbp->flag_ba_musnah ? 1 : 0) }}">
        <input type="hidden" name="nomor_ba_musnah" id="hidden_nomor_ba_musnah" value="{{ old('nomor_ba_musnah', $sbp->nomor_ba_musnah ?? '') }}">
        <input type="hidden" name="tanggal_ba_musnah" id="hidden_tanggal_ba_musnah" value="{{ old('tanggal_ba_musnah', $sbp->tanggal_ba_musnah ? \Carbon\Carbon::parse($sbp->tanggal_ba_musnah)->format('Y-m-d') : '') }}">
                ...
                if(hasBast) {
                    bastControlContainer.innerHTML = `
                        <button type="button" class="btn btn-primary w-100" id="viewBastBtn">
                            <i class="cil-share-boxed me-2"></i>Lihat/Edit BAST
                        </button>
                    `;
                } else {
                    bastControlContainer.innerHTML = `
                        <button type="button" class="btn btn-outline-primary w-100" id="createBastBtn">
                            <i class="cil-plus me-2"></i>Buat BAST
                        </button>
                    `;
                }
            }
                ...
                if(hasBaMusnah) {
                    baMusnahControlContainer.innerHTML = `
                        <button type="button" class="btn btn-success w-100" id="viewBaMusnahBtn">
                            <i class="cil-trash me-2"></i>Lihat/Edit BA Musnah
                        </button>
                    `;
                } else {
                    baMusnahControlContainer.innerHTML = `
                        <button type="button" class="btn btn-outline-success w-100" id="createBaMusnahBtn">
                            <i class="cil-plus me-2"></i>Buat BA Musnah
                        </button>
                    `;
                }
            }
