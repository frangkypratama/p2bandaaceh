                                    ...
                                    <div class="row g-3 mb-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="lokasi_penindakan" type="text" class="form-control" name="lokasi_penindakan" placeholder="Contoh: Bandara Internasional Sultan Iskandar Muda" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row g-3 mb-3">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="kecamatan" type="text" class="form-control" name="kecamatan" placeholder="Contoh: Jaya Baru">
                                            </div>
                                        </div>
