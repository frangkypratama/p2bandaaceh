...
@section('content')
    @php $lp = $lpp->lp; $lphp = optional($lp)->lphp; $sbp = optional($lphp)->sbp; @endphp
    <div class="container-lg">
        <form action="{{ route('lpp.update', $lpp->id) }}" method="POST" id="lppForm">
            @csrf
            @method('PUT')
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-warning text-dark">
                    <h4 class="card-title mb-0 d-flex align-items-center">
                        ...
                        <span><strong>Edit {{ $lpp->nomor_lpp }}</strong></span>
                    </h4>
                    <small class="text-muted">Tindak lanjut atas LP {{ optional($lp)->nomor_lp }}.</small>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" value="{{ optional($lphp)->pelaku_tidak_ditemukan ? 'Pelaku tidak ditemukan' : (optional($sbp)->nama_pelaku ?? '-') . ' (' . (optional($sbp)->nomor_identitas ?? '-') . ')' }}" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="date" class="form-control @error('tanggal_lpp') is-invalid @enderror"
                                                   id="tanggal_lpp" name="tanggal_lpp" value="{{ old('tanggal_lpp', $lpp->tanggal_lpp->format('Y-m-d')) }}" required>
                                            @error('tanggal_lpp')
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control @error('asal_perkara') is-invalid @enderror"
                                                   id="asal_perkara" name="asal_perkara" value="{{ old('asal_perkara', $lpp->asal_perkara) }}" required>
                                            @error('asal_perkara')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control @error('jenis_penindakan') is-invalid @enderror"
                                                   id="jenis_penindakan" name="jenis_penindakan" value="{{ old('jenis_penindakan', $lpp->jenis_penindakan) }}" required>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control @error('status_pelanggaran') is-invalid @enderror"
                                                   id="status_pelanggaran" name="status_pelanggaran" value="{{ old('status_pelanggaran', $lpp->status_pelanggaran) }}" required>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control @error('uraian_pelanggaran') is-invalid @enderror"
                                                      ...
                                                      required>{{ old('uraian_pelanggaran', $lpp->uraian_pelanggaran) }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control @error('dokumen_barang') is-invalid @enderror"
                                                      id="dokumen_barang" name="dokumen_barang" rows="2">{{ old('dokumen_barang', $lpp->dokumen_barang) }}</textarea>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control @error('catatan_atasan') is-invalid @enderror"
                                                      id="catatan_atasan" name="catatan_atasan" rows="2">{{ old('catatan_atasan', $lpp->catatan_atasan) }}</textarea>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select @error('konseptor_id') is-invalid @enderror" id="konseptor_id" name="konseptor_id" required>
                                                @foreach($petugasData as $petugas)
                                                    <option value="{{ $petugas->id }}" {{ old('konseptor_id', $lpp->konseptor_id) == $petugas->id ? 'selected' : '' }}>{{ $petugas->nama }}</option>
                                                @endforeach
                                            </select>
                                            @error('konseptor_id')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select @error('pemeriksa_id') is-invalid @enderror" id="pemeriksa_id" name="pemeriksa_id" required>
                                                @foreach($petugasData as $petugas)
                                                    <option value="{{ $petugas->id }}" {{ old('pemeriksa_id', $lpp->pemeriksa_id) == $petugas->id ? 'selected' : '' }}>{{ $petugas->nama }}</option>
                                                @endforeach
                                            </select>
                                            @error('pemeriksa_id')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select @error('pengampu_id') is-invalid @enderror" id="pengampu_id" name="pengampu_id" required>
                                                @foreach($petugasData as $petugas)
                                                    <option value="{{ $petugas->id }}" {{ old('pengampu_id', $lpp->pengampu_id) == $petugas->id ? 'selected' : '' }}>{{ $petugas->nama }}</option>
                                                @endforeach
                                            </select>
                                            @error('pengampu_id')
                                                <div class="invalid-feedback">{{ $message }}</div>
