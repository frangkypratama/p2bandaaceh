...
<head>
    <meta charset="UTF-8">
    <title>{{ $sbp->nomor_ba_musnah ?? '-' }}</title>
    <style>
        @page {
            size: 215mm 330mm;
            margin: 15mm;
...
<body>
    ...
    <div class="title">
        <h3>BERITA ACARA PEMUSNAHAN</h3>
        <p>Nomor : {{ $sbp->nomor_ba_musnah ?? '-' }}</p>
    </div>
    ...
    <table class="content-table">
        <tbody>
            ...
            <tr>
             ...
             <!-- LAPORAN & SAKSI -->
            <tr>
                <td colspan="4" class="full-width">Pemusnahan disaksikan oleh pengangkut/pemilik/importir/eksportir atau kuasanya/ketua lingkungan/dll*:</td>
            </tr>
            <tr>
                <td class="indent"></td>
    ...
    <table class="signature">
        <tbody>
            ...
            <tr>
                ...
                <td class="sig-right">Pejabat yang melakukan pemusnahan,</td>
            </tr>
            <tr>
                <td class="num"></td>
                <td class="sig-left">
