...
<div class="container-lg">
    <div class="card mb-4">
        <div class="card-header">
            <h5 class="card-title mb-0">Input Pencacahan</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('pencacahan.store') }}" method="POST" id="createPencacahanForm">
                @csrf
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="no_ba_cacah_nomor" placeholder="Masukkan hanya angka" required oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                            </div>
                            <input type="hidden" name="no_ba_cacah" id="no_ba_cacah">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-3">
